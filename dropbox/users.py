...
class SpaceUsage(object):
    ...
    :ivar allocated: The user's total space allocation (bytes).
    ...
    def __repr__(self):
        return 'SpaceUsage(allocated={!r}, used={!r})'.format(
...
SpaceUsage._allocated_validator = bv.UInt64()
...
SpaceUsage._all_fields_ = [
    ('allocated', SpaceUsage._allocated_validator),
